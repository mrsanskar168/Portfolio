...
const testimonials = [
  {
    content: "Sanskar Srivastav is great! He is very skillful and fast learner, just what you need in a developer.",
  ...
  {
    content: "Sanskar Srivastav produced some really amazing work on the backend. He demonstrated his proficiency and efficiency by using Node.js and Javascript to successfully import a very large dataset into a MySQL database.",
    author: "Arnel Bisnar",
